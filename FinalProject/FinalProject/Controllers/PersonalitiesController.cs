...
namespace FinalProject.Controllers
{
    public class PersonalitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,UserId,Q1,Q2,Q3,Q4,Q5")] Personality personality)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,UserId,Q1,Q2,Q3,Q4,Q5")] Personality personality)
        {
            if (ModelState.IsValid)
            {
